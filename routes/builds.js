...
// ─────────────────────────────────────────────
router.get('/', (req, res) => {
  res.render('builds/index', { title: 'Builds' });
});
...
router.get('/current', async (req, res, next) => {
  try {
    ...
    res.render('builds/current', { title: 'Current Builds', builds: rows });
  } catch (err) {
    next(err);
  }
});
...
router.get('/completed', async (req, res, next) => {
  try { 
    ...
    res.render('builds/completed', { title: 'Completed Builds', builds: rows });
  } catch (err) {
    next(err);
  }
});
