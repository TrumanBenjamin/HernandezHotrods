...
-- Started on 2025-08-16 15:12:33
...
-- Name: HernandezHotrods; Type: DATABASE; Schema: -; Owner: Hernandezadmin
--

CREATE DATABASE "HernandezHotrods" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'English_United States.1252';


ALTER DATABASE "HernandezHotrods" OWNER TO "Hernandezadmin";
...
-- Name: public; Type: SCHEMA; Schema: -; Owner: Hernandezadmin
--

-- *not* creating schema, since initdb creates it


ALTER SCHEMA public OWNER TO "Hernandezadmin";

--
-- TOC entry 225 (class 1255 OID 16404)
-- Name: set_updated_at(); Type: FUNCTION; Schema: public; Owner: Hernandezadmin
--
...
ALTER FUNCTION public.set_updated_at() OWNER TO "Hernandezadmin";
...
-- Name: build_photos; Type: TABLE; Schema: public; Owner: Hernandezadmin
--
...
ALTER TABLE public.build_photos OWNER TO "Hernandezadmin";

--
-- TOC entry 219 (class 1259 OID 16406)
-- Name: build_photos_id_seq; Type: SEQUENCE; Schema: public; Owner: Hernandezadmin
--
...
ALTER SEQUENCE public.build_photos_id_seq OWNER TO "Hernandezadmin";

--
-- TOC entry 4898 (class 0 OID 0)
-- Dependencies: 219
-- Name: build_photos_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Hernandezadmin
--
...
-- Name: build_section_items; Type: TABLE; Schema: public; Owner: Hernandezadmin
--
...
ALTER TABLE public.build_section_items OWNER TO "Hernandezadmin";

--
-- TOC entry 223 (class 1259 OID 16436)
-- Name: build_section_items_id_seq; Type: SEQUENCE; Schema: public; Owner: Hernandezadmin
--
...
ALTER SEQUENCE public.build_section_items_id_seq OWNER TO "Hernandezadmin";

--
-- TOC entry 4899 (class 0 OID 0)
-- Dependencies: 223
-- Name: build_section_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Hernandezadmin
--
...
-- Name: build_sections; Type: TABLE; Schema: public; Owner: Hernandezadmin
--
...
ALTER TABLE public.build_sections OWNER TO "Hernandezadmin";

--
-- TOC entry 221 (class 1259 OID 16421)
-- Name: build_sections_id_seq; Type: SEQUENCE; Schema: public; Owner: Hernandezadmin
--
...
ALTER SEQUENCE public.build_sections_id_seq OWNER TO "Hernandezadmin";

--
-- TOC entry 4900 (class 0 OID 0)
-- Dependencies: 221
-- Name: build_sections_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Hernandezadmin
--
...
-- Name: builds; Type: TABLE; Schema: public; Owner: Hernandezadmin
--
...
ALTER TABLE public.builds OWNER TO "Hernandezadmin";

--
-- TOC entry 217 (class 1259 OID 16390)
-- Name: builds_id_seq; Type: SEQUENCE; Schema: public; Owner: Hernandezadmin
--
...
ALTER SEQUENCE public.builds_id_seq OWNER TO "Hernandezadmin";

--
-- TOC entry 4901 (class 0 OID 0)
-- Dependencies: 217
-- Name: builds_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Hernandezadmin
--
...
-- Name: build_photos id; Type: DEFAULT; Schema: public; Owner: Hernandezadmin
--
...
-- Name: build_section_items id; Type: DEFAULT; Schema: public; Owner: Hernandezadmin
--
...
-- Name: build_sections id; Type: DEFAULT; Schema: public; Owner: Hernandezadmin
--
...
-- Name: builds id; Type: DEFAULT; Schema: public; Owner: Hernandezadmin
--
...
-- Dependencies: 220
-- Data for Name: build_photos; Type: TABLE DATA; Schema: public; Owner: Hernandezadmin
--
...
-- Dependencies: 224
-- Data for Name: build_section_items; Type: TABLE DATA; Schema: public; Owner: Hernandezadmin
--
...
-- Dependencies: 222
-- Data for Name: build_sections; Type: TABLE DATA; Schema: public; Owner: Hernandezadmin
--
...
-- Dependencies: 218
-- Data for Name: builds; Type: TABLE DATA; Schema: public; Owner: Hernandezadmin
--

INSERT INTO public.builds VALUES (1, '1969-camaro-rs', '1969 Camaro RS', 'Pro-touring street build', '/images/builds/1969-camaro-rs/hero.jpg', '/images/builds/1969-camaro-rs/thumb.jpg', true, '2025-08-14 20:08:31.187581-06', '2025-08-14 20:08:31.187581-06');
INSERT INTO public.builds VALUES (2, '1955-chevy-3100', '1955 Chevy 3100', 'Subtle restomod with modern comforts', '/images/builds/1955-chevy-3100/hero.jpg', '/images/builds/1955-chevy-3100/thumb.jpg', true, '2025-08-14 20:08:31.187581-06', '2025-08-14 20:08:31.187581-06');
INSERT INTO public.builds VALUES (3, '1970-c10-shop-truck', '1970 C10 “Shop Truck”', 'LS-swapped daily cruiser', '/images/builds/1970-c10/hero.jpg', '/images/builds/1970-c10/thumb.jpg', true, '2025-08-14 20:08:31.187581-06', '2025-08-14 20:08:31.187581-06');
INSERT INTO public.builds VALUES (4, '1968-mustang-fastback', '1968 Mustang Fastback', 'Track-inspired weekend car', '/images/builds/1968-mustang-fastback/hero.jpg', '/images/builds/1968-mustang-fastback/thumb.jpg', true, '2025-08-14 20:08:31.187581-06', '2025-08-14 20:08:31.187581-06');
INSERT INTO public.builds VALUES (5, '1979-trans-am', '1979 Trans Am', 'Street machine with attitude', '/images/builds/1979-trans-am/hero.jpg', '/images/builds/1979-trans-am/thumb.jpg', true, '2025-08-14 20:08:31.187581-06', '2025-08-14 20:08:31.187581-06');


--
-- TOC entry 4902 (class 0 OID 0)
-- Dependencies: 219
-- Name: build_photos_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Hernandezadmin
--
...
-- Dependencies: 223
-- Name: build_section_items_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Hernandezadmin
--
...
-- Dependencies: 221
-- Name: build_sections_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Hernandezadmin
--
...
-- Dependencies: 217
-- Name: builds_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Hernandezadmin
--
...
-- Name: build_photos build_photos_pkey; Type: CONSTRAINT; Schema: public; Owner: Hernandezadmin
--
...
-- Name: build_section_items build_section_items_pkey; Type: CONSTRAINT; Schema: public; Owner: Hernandezadmin
--
...
-- Name: build_sections build_sections_pkey; Type: CONSTRAINT; Schema: public; Owner: Hernandezadmin
--
...
-- Name: builds builds_pkey; Type: CONSTRAINT; Schema: public; Owner: Hernandezadmin
--
...
-- Name: builds builds_slug_key; Type: CONSTRAINT; Schema: public; Owner: Hernandezadmin
--
...
-- Name: idx_builds_published; Type: INDEX; Schema: public; Owner: Hernandezadmin
--
...
-- Name: idx_items_section; Type: INDEX; Schema: public; Owner: Hernandezadmin
--
...
-- Name: idx_photos_build; Type: INDEX; Schema: public; Owner: Hernandezadmin
--
...
-- Name: idx_sections_build; Type: INDEX; Schema: public; Owner: Hernandezadmin
--
...
-- Name: builds trg_builds_updated_at; Type: TRIGGER; Schema: public; Owner: Hernandezadmin
--
...
-- Name: build_photos build_photos_build_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Hernandezadmin
--
...
-- Name: build_section_items build_section_items_section_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Hernandezadmin
--
...
-- Name: build_sections build_sections_build_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Hernandezadmin
--
...
-- Completed on 2025-08-16 15:12:33
